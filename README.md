...
plus every breakpoint and its ±1 ulp neighbours — while running **460× faster**.
...
|---|---|---|---|
| `np.vectorize `(legacy) | 1.793 s | 5,837 | 1.00× |
| `pandas .apply` | 73.4 ms | 241 | 24× |
| `np.select` | 4.8 ms | 15 | 375× |
| **`searchsorted `(this repo)** | **3.9 ms** | **13** | **460×** |

*Measured on: Linux-6.18.5-fc-v20-x86_64-with-glibc2.39, Python 3.12.3, NumPy 2.4.4, pandas 3.0.2 — 300,000 rows, B738 (3 segments), median of 3 runs.*
<!-- BENCH:END -->
...
got 460× faster"* is an unverifiable claim.
