...
plus every breakpoint and its ±1 ulp neighbours — while running **422× faster**.
...
|---|---|---|---|
| `np.vectorize` (legacy) | 2.344 s | 1,833 | 1.00× |
| `pandas.apply` | 122.4 ms | 94 | 19× |
| `np.select` | 4.7 ms | 4 | 501× |
| **`searchsorted`** (this repo) | **5.6 ms** | **4** | **422×** |

*Measured on: macOS-26.3.1-arm64-arm-64bit-Mach-O, Python 3.13.11, NumPy 2.5.2, pandas 3.0.5 — 1,278,775 rows, B738 (3 segments), median of 3 runs.*
<!-- BENCH:END -->
...
got 422× faster"* is an unverifiable claim.
