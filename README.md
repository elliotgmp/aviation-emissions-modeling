...
plus every breakpoint and its ±1 ulp neighbours — while running **260× faster**.
...
|---|---|---|---|
| `np.vectorize` (legacy) | 2.207 s | 1,726 | 1.00× |
| `pandas.apply` | 117.6 ms | 91 | 19× |
| `np.select` | 4.9 ms | 4 | 446× |
| **`searchsorted`** (this repo) | **8.5 ms** | **6** | **260×** |
...
got 260× faster"* is an unverifiable claim.
